...
class FormBuilder
{
        ...
        switch ($type) {
            ...
            case 'submit':
                ...
                if ($this->recaptchaSiteKey) {
                    ...
                    $html .= '<br><button type="submit" onclick="onSubmit' . $this->postId . '(event)" data-action="submit" ' .
    ...
    private function getPriceOptions($atts)
    {
        ...
        $html .= '<p><br>' . __('Please, select currency *', 'mollie-forms') . '<br><br>
                <label>
                    <input type="radio" name="form_' . $post . '_field_currency" value="EUR" required>  
                    EUR
                </label>
                <label>
                    <input type="radio" name="form_' . $post . '_field_currency" value="CHF" required> 
                    CHF
                </label>               
               <br></p>';
